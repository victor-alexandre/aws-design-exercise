...
Cons: 
  ...
  - Existirá o atraso de 1 dia nas análises (creio que isso não gerará nenhuma degradação na hora de tomada de decisões, dado o domínio da aplicação, entretanto, para uma análise justa estou elencando este item como um ponto negativo).
